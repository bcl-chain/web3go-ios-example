 ...
 */
- (BOOL)getTransactionByHashIsPending:(GethContext*)ctx hash:(GethHash*)hash ret0_:(BOOL*)ret0_ error:(NSError**)error;
/**
...
@interface GethHomesteadSigner : NSObject <goSeqRefInterface> {
}
@property(strong, readonly) id _ref;
 ...
 */
@property (nonatomic) GethEnodes* bootstrapNodes;
/**
...
@interface GethPrivateKey : NSObject <goSeqRefInterface> {
}
@property(strong, readonly) id _ref;

- (instancetype)initWithRef:(id)ref;
- (instancetype)init;
- (GethPublicKey*)public;
@end

@interface GethPublicKey : NSObject <goSeqRefInterface> {
}
@property(strong, readonly) id _ref;
...
@interface GethSigner2 : NSObject <goSeqRefInterface> {
}
@property(strong, readonly) id _ref;
...
FOUNDATION_EXPORT NSData* GethCompressPubkey(GethPublicKey* wpubkey);

FOUNDATION_EXPORT GethAddress* GethCreateAddress(GethAddress* wb, int64_t wnonce);

FOUNDATION_EXPORT NSData* GethDecode(NSString* input, NSError** error);

FOUNDATION_EXPORT GethBigInt* GethDecodeBig(NSString* s, NSError** error);

FOUNDATION_EXPORT GethPublicKey* GethDecompressPubkey(NSData* pubkey, NSError** error);
...
FOUNDATION_EXPORT NSData* GethEcrecover(NSData* hash, NSData* sig, NSError** error);

FOUNDATION_EXPORT NSString* GethEncode(NSData* b);

FOUNDATION_EXPORT NSString* GethEncodeBig(GethBigInt* wbigint);
...
FOUNDATION_EXPORT NSData* GethFromECDSA(GethPrivateKey* priv);

FOUNDATION_EXPORT NSData* GethFromECDSAPub(GethPublicKey* pub);

FOUNDATION_EXPORT GethPrivateKey* GethGenerateKey(NSError** error);

FOUNDATION_EXPORT GethPrivateKey* GethHexToECDSA(NSString* hexkey, NSError** error);
 ...
 */
FOUNDATION_EXPORT NSData* GethKeccak256(NSData* data);
 ...
 * TODO: input type of original Keccak256Hash is ...[]byte.
      ...
      have to check if this modification is fine or not.
 */
FOUNDATION_EXPORT GethHash* GethKeccak256Hash(NSData* data);
 ...
 * TODO: input type of original Keccak512 is ...[]byte.
      ...
      have to check if this modification is fine or not.
 */
FOUNDATION_EXPORT NSData* GethKeccak512(NSData* data);

FOUNDATION_EXPORT GethPrivateKey* GethLoadECDSA(NSString* file, NSError** error);
...
FOUNDATION_EXPORT NSData* GethMustDecode(NSString* s);

FOUNDATION_EXPORT GethBigInt* GethMustDecodeBig(NSString* s);
...
FOUNDATION_EXPORT GethSigner2* GethNewHomesteadSigner(void);
...
FOUNDATION_EXPORT GethAddress* GethPubkeyToAddress(GethPublicKey* pub);
...
FOUNDATION_EXPORT BOOL GethSaveECDSA(NSString* file, GethPrivateKey* wpriv, NSError** error);

FOUNDATION_EXPORT GethAddress* GethSender(GethSigner2* ws, GethTransaction* wtx, NSError** error);
...
FOUNDATION_EXPORT GethPublicKey* GethSigToPub(NSData* hash, NSData* sig, NSError** error);

FOUNDATION_EXPORT NSData* GethSign(NSData* hash, GethPrivateKey* wprv, NSError** error);

FOUNDATION_EXPORT GethTransaction* GethSignTx(GethTransaction* wtx, GethSigner2* ws, GethPrivateKey* wprv, NSError** error);
...
FOUNDATION_EXPORT GethPrivateKey* GethToECDSA(NSData* d, NSError** error);

FOUNDATION_EXPORT GethPrivateKey* GethToECDSAUnsafe(NSData* d);

FOUNDATION_EXPORT GethPublicKey* GethUnmarshalPubkey(NSData* pub, NSError** error);

FOUNDATION_EXPORT BOOL GethVerifySignature(NSData* pubkey, NSData* hash, NSData* sig);
